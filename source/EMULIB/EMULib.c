...
#if defined(WINDOWS) || defined(UNIX) || defined(ORBIS) || defined(MAEMO) || defined(MEEGO) || defined(ANDROID)
#define NewImage GenericNewImage
#endif

#if defined(WINDOWS) || defined(UNIX) || defined(ORBIS) || defined(MAEMO) || defined(MEEGO)
#define FreeImage GenericFreeImage
#define CropImage GenericCropImage
extern Image BigScreen;
#endif

#if defined(UNIX) || defined(ORBIS) || defined(MAEMO) || defined(MEEGO) || defined(ANDROID)
...
void SetVideo(Image *Img,int X,int Y,int W,int H)
{
  ...
  debugNetPrintf(3,"videox %d videoy %d videow %d videoh %d\n",VideoX,VideoY,VideoW,VideoH);
